...
public class PDFBookTable {
    public static void main(String[] args) throws MalformedURLException, IOException {
        ...
        new PDFBookTable().createPdf(dest);
    }
    public void createPdf(String dest) throws MalformedURLException, IOException {
        ...
        try {
            headerFont = PdfFontFactory.createFont("BMJUA_otf.otf", "Identity-H", true);
            bodyFont = PdfFontFactory.createFont("BMJUA_otf.otf", "Identity-H", true);
        } catch (IOException e) {
            e.printStackTrace();
        }
        // Initialize table
        ...
        for (Map<String, String> book : books) {
            ...
            try {
                ...
                System.err.println("Error loading image for book: " + title);
                e.printStackTrace();
            }
            rowNum++;
        }
